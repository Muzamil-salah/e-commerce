...
//         return axios.get('http://localhost:3000/api/v1/product/bycategory?categories=laptop')
//       }
...
//       <div className='Dark-Color mt-5 pt-5'>
...
export default function Laptop() {
   ...
   let {addToWishList , setWCounter , removeWishItem ,getFromWishList }= useContext(WishListContext)
    ...
    function getProducts(){
        return axios.get('http://localhost:3000/api/v1/category/name?name=Accessories')
      }
